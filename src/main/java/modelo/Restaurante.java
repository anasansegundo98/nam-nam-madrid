...
public class Restaurante {
	...
	public Restaurante(int idrestaurante, String nombre, int zona_id, String direccion, String categoria_id,
			int precio_medio, String url_google_maps, String descripcion, int destacado, int creado_por) {
	...
	public String informacion() {
		return "ID: " + idrestaurante + ", Nombre: " + nombre + ", Zona: " + zona_id + ", Dirección: " + direccion
				+ ", Precio medio: " + precio_medio + " €" + ", Google Maps: " + url_google_maps + ", Descripción: "
				+ descripcion + ", Destacado: " + destacado + ", Creado por: " + creado_por;
	}
